          ...
          >
            ...
            <div className="absolute inset-0 w-[1080px] h-[1920px] z-10" style={{ fontFamily: 'inherit' }}>
              ...
              <div className="absolute inset-0" style={{ fontFamily: 'inherit' }}>
                <div className="absolute top-[270px] right-[70px] text-[#002043] text-4xl font-black" style={{ fontFamily: 'inherit', fontWeight: '900' }}>
                  {selectedRegion}
                </div>
                ...
                <div className="absolute top-[620px] left-[510px] text-[#002043] text-3xl font-bold" style={{ fontFamily: 'inherit', fontWeight: '700' }}>
                  {parcelas}x de
                </div>
                <div className="absolute top-[660px] left-[510px] text-[#002043] text-6xl font-black" style={{ fontFamily: 'inherit', fontWeight: '900' }}>
                  R$
                </div>
                <div className="absolute top-[605px] left-[600px] text-[#002043] text-[126px] font-black" style={{ fontFamily: 'inherit', fontWeight: '900' }}>
                  {baseValue.toFixed(2).replace(".", ",")}
                </div>
                <div className="absolute top-[760px] left-[518px] text-[#002043] text-[28px] font-semibold" style={{ fontFamily: 'inherit', fontWeight: '600' }}>
                ...
                <div className="absolute top-[1070px] left-[410px] text-[#002043] text-xl font-bold" style={{ fontFamily: 'inherit', fontWeight: '700' }}>
                  saindo de
                </div>
                <div className="absolute top-[1100px] left-[410px] text-[#002043] text-xl font-black" style={{ fontFamily: 'inherit', fontWeight: '900' }}>
                  {getDepartureAirport()}
                </div>
                ...
                <div className="absolute top-[1250px] left-[580px] text-[#002043] text-3xl font-bold" style={{ fontFamily: 'inherit', fontWeight: '700' }}>
                  Contato e Whatsapp
                </div>
                <div className="absolute top-[1285px] left-[580px] text-[#002043] text-3xl font-bold" style={{ fontFamily: 'inherit', fontWeight: '700' }}>
                  (67) 9 9637-2769
                </div>
              </div>
            </div>
